 ...
 * @param bootId identifies one device uptime, so records can still be ordered across sessions
 *   when the terminal's wall clock is wrong (POS clocks routinely are).
